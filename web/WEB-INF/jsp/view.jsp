...
<%@ page import="com.oleginno.webapp.model.*" %>
...
<head>
    ...
    <jsp:useBean id="resume" type="com.oleginno.webapp.model.Resume" scope="request"/>
...
<section>
    ...
    <p>
        <c:forEach var="type" items="${resume.contacts.keySet()}">
            <jsp:useBean id="type" type="com.oleginno.webapp.model.ContactType"/>
...
//                Section section =  ((Section) entry.getValue());
            ...
            <c:forEach var="org" items="<%=((OrganizationSection) entry.getValue()).getValues()%>">
                ...
                <c:forEach var="period" items="${org.periods}">
                    <jsp:useBean id="period" type="com.oleginno.webapp.model.Organization.Period"/>
                    <tr>
                        <td><%=HtmlUtil.format(period.getStartDate())%> - <%=HtmlUtil.format(
                                period.getEndDate())%></td>
